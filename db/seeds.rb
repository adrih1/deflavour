...
data = {
  ...
  "Boise" => { description: "coucou",
    aromas: [	"Pin ",	"Cedre",	"Bois de santal",	"Chêne",	"Encens",	"boite à cigare",	"Bois brulé",	"Tannique",	"Réglisse","Bois"]},
  "Animal" => { description: "coucou",
    aromas:	["Cuir",	"Musc","Animal", "Foururre", "Ecurie"]},

...
#supprimer les différentes conte,ances pour un meme alcool et supprimer là où on a pas de données
    ...
    if spirit.name.include?("1L") || spirit.name.include?("1.5L") || spirit.name.include?("50cl") || spirit.name.include?("1.75L") || spirit.description.nil? || spirit.country.nil? || spirit.name.include?("3L")
      spirit.destroy!
